        ...
        return (
            <div className="card">
                <div className="card-body">
                    ...
                    <div className="row">
                        <Divider></Divider>
                        <div className="col-sm-6 d-flex justify-content-between mt-2">
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-6 d-flex justify-content-between mt-2">
                            <div className="d-flex align-items-baseline">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cloud-fog-fill" viewBox="0 0 16 16">
