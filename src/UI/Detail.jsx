    ...
    <div className={classes.root}>
      <Accordion square={true}>
        ...
        >
          ...
          <div className={classes.column}>
            <Typography className={classes.secondaryHeading}>{`${props.max}°/${props.min}°`}</Typography>
          </div>
          <div className={classes.column}>
            <img src={props.icon} className="rounded" alt=""></img>
            <Typography className={classes.secondaryHeading}>{props.text}</Typography>
          </div>
          <div className={classes.column2}>
            ...
            <Typography className={classes.secondaryHeading}>{`${props.chance}%`}</Typography>
          </div>
          <div className={classes.column2}>
            ...
            <Typography className={classes.secondaryHeading}>{`${props.windy}km/h`}</Typography>
          </div>
        </AccordionSummary>
