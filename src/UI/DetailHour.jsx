...
import CardHour from '../UI/CardHour';
      ...
      <Accordion square={true}>
        ...
        >
          <div className={classes.column}>
            <h6>{ Control.time_24to12(Control.splitDate(props.hour.time))}</h6>
          </div>
          <div className={classes.column}>
            <h5><strong>{props.hour.temp_c}°</strong></h5>
          </div>
          <div className={classes.column}>
            <img src={props.hour.condition.icon} className="rounded" alt=""></img>
            <h6>{props.hour.condition.text}</h6>
          </div>
          <div className={classes.column2}>
            ...
            <h6>{props.hour.chance_of_rain}%</h6>
          </div>
          <div className={classes.column2}>
            ...
            <h6>{props.hour.wind_dir} - {props.hour.wind_kph} km/h</h6>
          </div>
        </AccordionSummary>
